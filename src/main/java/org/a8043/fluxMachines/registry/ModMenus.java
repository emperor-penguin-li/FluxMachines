...
public final class ModMenus {
    ...
    public static final RegistryObject<MenuType<AdvancedProcessingMachineMenu>> ADVANCED_PROCESSING_MACHINE =
        REGISTER.register("advanced_processing_machine", () -> IForgeMenuType.create(AdvancedProcessingMachineMenu::fromNetwork));
